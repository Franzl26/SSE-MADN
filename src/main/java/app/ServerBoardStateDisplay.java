...
public class ServerBoardStateDisplay extends AnchorPane { // todo entfernen
    ...
    public static String getText(GameStatistics gameStatistics, LoggedInInterface[] clients, String[] names, FieldState[] fields, boolean[] finished, int anzahlFinished, int spielerAnzahl, int aktiverSpieler, int zahlGewuerfelt, int anzahlWuerfeln) {
        return "names: " + Arrays.toString(names) + "\nclients: " + Arrays.toString(clients) + "\nfields: " + Arrays.toString(fields) + "\nfinished: " + anzahlFinished + ": " + Arrays.toString(finished) + "\nspielerAnzahl: " + spielerAnzahl + "\naktiverSpieler: " + aktiverSpieler + "  wuerfel: " + zahlGewuerfelt + "  anzWuerfel: " + anzahlWuerfeln + "\n" + gameStatistics;
    }
